...
<aside class="notice">This API has been deprecated. Please refer to the documentation for our new [Locations API](https://developer.brightlocal.com/docs/management-apis/a8chirfprjb2p-locations).</aside>
